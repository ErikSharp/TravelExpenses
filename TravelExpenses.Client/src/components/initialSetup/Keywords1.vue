<template>
  <v-card class="pa-3">
    ...
    <p>
      Keywords are a way to further describe a transaction. A transaction must
      be tied to one Category, but can have zero or more Keywords.
    </p>
    <p>
    ...
    <p>
      <strong>e.g.</strong> How much did we spend on coffee in Chiang Mai,
      Thailand?
    </p>
    <v-flex xs12>
