...
namespace TravelExpenses.Persistence.Extensions
{
    public static class ModelBuilderExtensions
    {
        /// <summary>
        /// Will apply configuration in any IEntityTypeConfiguration implementations
        /// </summary>
        public static void ApplyAllConfigurations(this ModelBuilder modelBuilder)
        {
            ...
            var ret = typeof(TravelExpensesContext).Assembly
                .GetTypes()
